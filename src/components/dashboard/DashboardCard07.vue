<template>
  <div class="col-span-full rounded-xl bg-white shadow-sm dark:bg-gray-800 xl:col-span-8">
    ...
    <div class="p-3">
      ...
      <div class="overflow-x-auto">
        <table class="w-full table-auto dark:text-gray-300">
          <!-- Table header -->
          <thead
            class="rounded-sm bg-gray-50 text-xs uppercase text-gray-400 dark:bg-gray-700 dark:bg-opacity-50 dark:text-gray-500"
          >
            <tr>
              <th class="p-2">
                <div class="text-left font-semibold">Source</div>
              </th>
              <th class="p-2">
                <div class="text-center font-semibold">Visitors</div>
              </th>
              <th class="p-2">
                <div class="text-center font-semibold">Revenues</div>
              </th>
              <th class="p-2">
                <div class="text-center font-semibold">Sales</div>
              </th>
              <th class="p-2">
                <div class="text-center font-semibold">Conversion</div>
              </th>
            </tr>
          </thead>
          <!-- Table body -->
            ...
            <tr>
              <td class="p-2">
                <div class="flex items-center">
                  <svg class="mr-2 shrink-0 sm:mr-3" width="36" height="36" viewBox="0 0 36 36">
