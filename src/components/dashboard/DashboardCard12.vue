<template>
  <div class="col-span-full rounded-xl bg-white shadow-sm dark:bg-gray-800 xl:col-span-6">
    ...
    <div class="p-3">
      ...
      <div>
        <header
          class="rounded-sm bg-gray-50 p-2 text-xs font-semibold uppercase text-gray-400 dark:bg-gray-700 dark:bg-opacity-50 dark:text-gray-500"
        >
          Today
        </header>
        <ul class="my-1">
          <!-- Item -->
          <li class="flex px-2">
            <div class="my-2 mr-3 h-9 w-9 shrink-0 rounded-full bg-violet-500">
              <svg class="h-9 w-9 fill-current text-white" viewBox="0 0 36 36">
                <path
            ...
            <div
              class="flex grow items-center border-b border-gray-100 py-2 text-sm dark:border-gray-700/60"
            >
              <div class="flex grow justify-between">
                ...
                <div class="ml-2 shrink-0 self-end">
                  <a
                    ...
                    href="#0"
                    >View<span class="hidden sm:inline"> -&gt;</span></a
                  >
                </div>
              </div>
            </div>
          ...
          <!-- Item -->
          <li class="flex px-2">
            <div class="my-2 mr-3 h-9 w-9 shrink-0 rounded-full bg-red-500">
              <svg class="h-9 w-9 fill-current text-white" viewBox="0 0 36 36">
          ...
          <!-- Item -->
          <li class="flex px-2">
            <div class="my-2 mr-3 h-9 w-9 shrink-0 rounded-full bg-green-500">
              <svg class="h-9 w-9 fill-current text-white" viewBox="0 0 36 36">
                <path
      ...
      <div>
        ...
        <ul class="my-1">
          <!-- Item -->
          <li class="flex px-2">
            <div class="my-2 mr-3 h-9 w-9 shrink-0 rounded-full bg-sky-500">
              <svg class="h-9 w-9 fill-current text-white" viewBox="0 0 36 36">
                <path
