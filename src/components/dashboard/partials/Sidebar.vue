<template>
  <div class="min-w-fit">
    ...
    <div
      class="fixed inset-0 z-40 bg-gray-900 bg-opacity-30 transition-opacity duration-200 lg:z-auto lg:hidden"
    ...
    <div
      id="sidebar"
      ref="sidebar"
      class="no-scrollbar lg:sidebar-expanded:!w-64 absolute left-0 top-0 z-40 flex h-[100dvh] w-64 shrink-0 flex-col overflow-y-scroll bg-white p-4 transition-all duration-200 ease-in-out dark:bg-gray-800 lg:static lg:left-auto lg:top-auto lg:!flex lg:w-20 lg:translate-x-0 lg:overflow-y-auto 2xl:!w-64"
      :class="[
        variant === 'v2'
          ...
          <ul class="mt-3">
            ...
            >
              ...
              <div class="lg:sidebar-expanded:block lg:hidden 2xl:block">
                <ul class="mt-1 pl-8" :class="!parentLink.expanded && 'hidden'">
            ...
            <SidebarLinkGroup
              v-slot="parentLink"
              :activeCondition="currentRoute.fullPath.includes('job')"
            >
              <a
                class="block truncate text-gray-800 transition dark:text-gray-100"
                :class="
            ...
            <router-link to="/messages" custom v-slot="{ href, navigate, isExactActive }">
              <li
                class="mb-0.5 rounded-lg bg-[linear-gradient(135deg,var(--tw-gradient-stops))] py-2 pl-4 pr-3 last:mb-0"
                :class="
                  isExactActive &&
                  ...
                  <div class="flex items-center justify-between">
                    <div class="flex grow items-center">
                      <svg
                        class="shrink-0 fill-current"
                        :class="
                          isExactActive ? 'text-violet-500' : 'text-gray-400 dark:text-gray-500'
                        "
                        xmlns="http://www.w3.org/2000/svg"
                        width="16"
                        height="16"
                    ...
                    <div class="ml-2 flex flex-shrink-0">
                      <span
                        class="inline-flex h-5 items-center justify-center rounded bg-violet-400 px-2 text-xs font-medium text-white"
                        >4</span
                      >
                    </div>
                  </div>
              ...
              <div class="lg:sidebar-expanded:block lg:hidden 2xl:block">
                <ul class="mt-1 pl-8" :class="!parentLink.expanded && 'hidden'">
                  <router-link to="/signin" custom v-slot="{ href, navigate }">
                    <li class="mb-1 last:mb-0">
                      <a
                        class="block truncate text-gray-500/90 transition hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200"
                        :href="href"
                        @click="navigate"
                      >
                        <span
      ...
      <div class="mt-auto hidden justify-end pt-3 lg:inline-flex 2xl:hidden">
        <div class="w-12 py-2 pl-4 pr-3">
          ...
          >
            ...
            <svg
              class="sidebar-expanded:rotate-180 shrink-0 fill-current text-gray-400 dark:text-gray-500"
              xmlns="http://www.w3.org/2000/svg"
              width="16"
              height="16"
              viewBox="0 0 16 16"
