<template>
  ...
  >
    ...
    >
      <div
        ref="modalContent"
        class="max-h-full w-full max-w-2xl overflow-auto rounded-lg border border-transparent bg-white shadow-lg dark:border-gray-700/60 dark:bg-gray-800"
      >
        <!-- Search form -->
        <form class="border-b border-gray-200 dark:border-gray-700/60">
          <div class="relative">
            ...
            <button class="group absolute inset-0 right-auto" type="submit" aria-label="Search">
              <svg
                class="ml-4 mr-2 shrink-0 fill-current text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-400"
                width="16"
                height="16"
                viewBox="0 0 16 16"
        ...
        <div class="px-2 py-4">
          ...
          <div class="mb-3 last:mb-0">
            <div class="mb-2 px-2 text-xs font-semibold uppercase text-gray-400 dark:text-gray-500">
              Recent searches
            </div>
            <ul class="text-sm">
              <li>
                <router-link
                  class="flex items-center rounded-lg p-2 text-gray-800 hover:bg-gray-100 dark:text-gray-100 dark:hover:bg-gray-700/20"
                  to="#0"
                  @click="$emit('close-modal')"
                >
                  <svg
                    class="mr-3 shrink-0 fill-current text-gray-400 dark:text-gray-500"
                    width="16"
                    height="16"
                    viewBox="0 0 16 16"
                  >
