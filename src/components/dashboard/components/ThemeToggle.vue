<template>
  <div>
    ...
    />
    <label
      class="flex h-8 w-8 cursor-pointer items-center justify-center rounded-full hover:bg-gray-100 dark:hover:bg-gray-700/50 lg:hover:bg-gray-200 dark:lg:hover:bg-gray-800"
      for="light-switch"
    >
      <svg
        class="fill-current text-gray-500/80 dark:hidden dark:text-gray-400/80"
        width="16"
        height="16"
        viewBox="0 0 16 16"
      ...
      <svg
        class="hidden fill-current text-gray-500/80 dark:block dark:text-gray-400/80"
        width="16"
        height="16"
        viewBox="0 0 16 16"
        xmlns="http://www.w3.org/2000/svg"
